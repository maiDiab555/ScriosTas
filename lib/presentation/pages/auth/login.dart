...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Loginddgg"),),
      body: Container(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      onPressed:() {
                                        getUserData(emailController.text.toString(),pwdController.text.toString());
                                      },
  ...
  getUserData(String email,String pass) async {
    final SharedPreferences localData = await SharedPreferences.getInstance();
    getUserEmail=localData.getString("username").toString();
    getUserPass=localData.getString("password").toString();

    if(email==getUserEmail && pass==getUserPass){
