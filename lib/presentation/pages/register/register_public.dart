...
class _RegisterPublicState extends State<RegisterPublic> {
  final  _reg1Form = GlobalKey<FormState>();
                            ...
                            Padding(
                              ...
                              child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    SignUpUser(emailController.text.toString());
                                  },
                                  child: const Text(
                                    'Submit',
                                    style: TextStyle(
  ...
  Future<void> SignUpUser(email) async {
     final SharedPreferences localData = await SharedPreferences.getInstance();
     localData.setString('username', email);
     localData.setString('password', pwdController.text.toString());
    ...
    print("emailllll${localData.get("username")}");
  }
